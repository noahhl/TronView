...
class BZ(Screen):
    ...
    def __init__(self):
        ...
        self.name = "BZ HUD"  # set name for this screen
    ...
    def draw(self, aircraft, smartdisplay):
        ...
        smartdisplay.draw_text(smartdisplay.RIGHT_MID_DOWN, self.fontIndicatorSmaller, "MP %0.1f" % (aircraft.engine.ManPress), (255, 255, 0))
        #CHT
        smartdisplay.draw_text(smartdisplay.RIGHT_MID_DOWN, self.fontIndicatorSmaller, "CHT %d" % (max(aircraft.engine.CHT)), (255, 255, 0))
        #OilT
        smartdisplay.draw_text(smartdisplay.RIGHT_MID_DOWN, self.fontIndicatorSmaller, "OilT %d" % (aircraft.engine.OilTemp), (255, 255, 0))
        smartdisplay.draw_text(smartdisplay.RIGHT_MID_DOWN, self.fontIndicatorSmaller, "OilP %d" % (aircraft.engine.OilPress), (255, 255, 0))
        smartdisplay.draw_text(smartdisplay.RIGHT_MID_DOWN, self.fontIndicatorSmaller, "FF %0.1f" % (aircraft.engine.FuelFlow), (255, 255, 0))
        ...
        # draw wind direction
        #self.wind.draw(aircraft,smartdisplay,(15,smartdisplay.y_end - 250))

        # draw Slip Skid
        self.slipskid.draw(aircraft,smartdisplay,(smartdisplay.x_center,smartdisplay.y_end-175))

        # draw AOA indicator
        #self.aoa.draw(aircraft,smartdisplay,(smartdisplay.x_start + 200 ,smartdisplay.y_end - 320))
